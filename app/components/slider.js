...
class Slider extends Component {
  ...
  startButtonHoverAnim = () => {
    Animated.timing(
      ...
      {
        toValue: this.getHoverScaleRatio(40, 24),
        duration: 10,
  ...
  renderCustomThumbButton = valueRatio => {
    const {thumbButtonSize, customThumb} = this.props
    if(customThumb)
    return (
      <Animated.View
        hitSlop={this._hitSlopConfig}
  ...
  render() {
    ...
    return (
      <View style={styles.sliderContainer}>
        ...
        {/* Slider thumb button */}
        {customThumb ? this.renderCustomThumbButton(valueRatio) : this.renderThumbButton(valueRatio)}
